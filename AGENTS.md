...
This project is indexed by GitNexus as **Focus-Flow** (1704 symbols, 2709 relationships, 63 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
